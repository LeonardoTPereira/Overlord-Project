...
{
    [SerializeField]
    protected GameObject dropdownCanvas;
    ...
    public void Awake()
    {
        profileDropdowns = dropdownCanvas.GetComponentsInChildren<TMP_Dropdown>().ToDictionary(key => key.name, inputFieldObj => inputFieldObj);
    }
