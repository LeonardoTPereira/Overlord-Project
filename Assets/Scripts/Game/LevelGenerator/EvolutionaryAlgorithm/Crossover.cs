...
namespace Game.LevelGenerator.EvolutionaryAlgorithm
{
    ...
    public static class Crossover
    {
        ...
        public static Individual[] Apply(Individual parent1, Individual parent2) {
            ...
            individuals[0] = new Individual(parent1.Fitness.DesiredParameters);
            individuals[1] = new Individual(parent1.Fitness.DesiredParameters);
        ...
        private static int CalculateBranchRooms(List<int> missions, Room root) {
            ...
            while (toVisit.Count > 0)
            {
                ...
                EnqueueChildrenRooms(current, toVisit);
            }
            return rooms;
        }

        private static void EnqueueChildrenRooms(Room current, Queue<Room> toVisit)
        {
