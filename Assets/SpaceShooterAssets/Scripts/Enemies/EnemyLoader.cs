...
public class EnemyLoader : MonoBehaviour
{
    ...
    */
    ...
    public void LoadEnemies(int amount, System.Action onCleared)
    {
        ...
        StartCoroutine(SpawnRoutine(onCleared));
    }

    private List<EnemySO> GetRandomEnemyList(int amount, List<EnemySO> enemies)
    {
    ...
    IEnumerator SpawnRoutine(System.Action onCleared)
    {
        SpawnAll();

        while (FindObjectsOfType<SpaceShooterEnemy>().Length > 0)
            yield return null;
